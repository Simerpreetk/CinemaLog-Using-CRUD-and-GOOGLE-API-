...
- Navigate to /plans/Add while anonymous
...
- Open a browser and navigate to https://github.com/settings/applications/new
    ...
    - Authorization callback URL is http://localhost:3000/auth/callback this URL needs to change when deploying to Render or Azure
